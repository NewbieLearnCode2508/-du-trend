...
btn.onclick = () => {
  if (
    ...
    document.querySelector(".STARDUST2").textContent =
      document.getElementById("name-img").value;
    document.querySelector(".img").src =
      document.getElementById("url-img").value;
    document.querySelector("#pinkboard").style.height = window.innerHeight;
    document.querySelector("#pinkboard").style.height = window.innerWidth;
